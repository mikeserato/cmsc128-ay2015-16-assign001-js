...
function wordsToCurrency(word, currency){
	...
	if ((currency == 'JPY') || (currency == 'PHP') || (currency == 'USD')) var answer = currency;	//checks if the currency input is either JPY, PHP or USD
	...
	answer += value;												//combines the digit to the currency
	return answer;													//prints the answer
}